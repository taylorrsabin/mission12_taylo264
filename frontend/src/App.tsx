...
function Welcome() {
  return (
    <div>
      <h1 className="App-logo">Mission 12</h1>
      <h3>This is a webpage about NCAA basketball teams</h3>
      <h6>See the teams below</h6>
    </div>
  );
}
    ...
    return (
      <div>
        <Card>
          ...
          <h5>Location: {oneTeam.city}, {oneTeam.state}</h5>
        </Card>
      </div>
    );
  }
...
function TeamNameList() {
  return(
    <div>
      {teams.map(oneTeam => <TeamName {...oneTeam} />)}  
    </div>
  )
}
  ...
  return (
    <div className="App">
      ...
      <Container>
        <Row>
          <Col><h1>Teams</h1></Col>
          <Col><h1>Team Information</h1></Col>
        </Row>
        <Row>
          <Col>
            <Card>
